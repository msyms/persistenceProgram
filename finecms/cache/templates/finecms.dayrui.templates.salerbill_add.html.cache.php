            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="tab_0">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo fc_lang('饮料'); ?>：</label>
                            <div class="col-md-9">
                                <label><input class="form-control" type="text" name="data[drinkNum]" value="<?php echo $data['bucketNum']; ?>" ></label>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
