...
--
-- Table structure for table `fn_1_block`
--
...
--
-- Table structure for table `fn_1_category`
--
...
--
-- Table structure for table `fn_1_form`
--
...
--
-- Dumping data for table `fn_1_form`
--
...
--
-- Table structure for table `fn_1_form_liuyan`
--
...
--
-- Table structure for table `fn_1_form_liuyan_data_0`
--
...
--
-- Table structure for table `fn_1_index`
--
...
--
-- Table structure for table `fn_1_news`
--
...
--
-- Table structure for table `fn_1_news_data_0`
--
...
--
-- Table structure for table `fn_1_tag`
--
...
--
-- Dumping data for table `fn_1_tag`
--
...
--
-- Table structure for table `fn_1_weixin`
--
...
--
-- Table structure for table `fn_1_weixin_follow`
--
...
--
-- Table structure for table `fn_1_weixin_menu`
--
...
--
-- Table structure for table `fn_1_weixin_user`
--
...
--
-- Table structure for table `fn_attachment`
--
...
--
-- Table structure for table `fn_attachment_0`
--
...
--
-- Table structure for table `fn_attachment_1`
--
...
--
-- Table structure for table `fn_attachment_2`
--
...
--
-- Table structure for table `fn_attachment_3`
--
...
--
-- Table structure for table `fn_attachment_4`
--
...
--
-- Table structure for table `fn_attachment_5`
--
...
--
-- Table structure for table `fn_attachment_6`
--
...
--
-- Table structure for table `fn_attachment_7`
--
...
--
-- Table structure for table `fn_attachment_8`
--
...
--
-- Table structure for table `fn_attachment_9`
--
...
--
-- Table structure for table `fn_customer`
--
...
--
-- Table structure for table `fn_field`
--
...
--
-- Dumping data for table `fn_field`
--
...
--
-- Table structure for table `fn_linkage_data_1`
--
...
--
-- Dumping data for table `fn_linkage_data_1`
--
...
--
-- Table structure for table `fn_mail_smtp`
--
...
(1, '', 'admin', 'ac7cd59472be180b81c7551b92925f03', 'b3967a0e93', '1212', '12', '', '9999.00', '0.00', '0.00', 10000, 10000, 1, 3, 4, 0, '', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `fn_member_data`
--
...
--
-- Dumping data for table `fn_member_data`
--
...
--
-- Table structure for table `fn_member_oauth`
--
...
--
-- Table structure for table `fn_module`
--
...
--
-- Dumping data for table `fn_module`
--
...
--
-- Table structure for table `fn_saler`
--
...
--
-- Dumping data for table `fn_saler`
--
...
--
-- Table structure for table `fn_site`
--
...
--
-- Dumping data for table `fn_site`
--
...
--
-- Table structure for table `fn_urlrule`
--
...
--
-- Dumping data for table `fn_urlrule`
--
