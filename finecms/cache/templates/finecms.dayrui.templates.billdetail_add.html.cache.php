...
<div class="form-body">
    ...
    <div class="form-group dr_one">
        ...
        <div class="col-md-7">
            <input class="form-control" type="text" name="data[bucketNum]" id="dr_phone" value="<?php echo $data['bucketNum']; ?>" >
        </div>
    </div>
    <div class="form-group dr_one">
        <label class="col-md-3 control-label"><?php echo fc_lang('瓶装水数量'); ?>：</label>
        <div class="col-md-7">
            <input class="form-control" type="text" name="data[bottleNum]" id="dr_address" value="<?php echo $data['bottleNum']; ?>" >
        </div>
    </div>
    <div class="form-group dr_one">
